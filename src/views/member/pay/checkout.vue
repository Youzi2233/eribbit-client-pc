    ...
    <div class="container">
      ...
      <div class="wrapper" v-if="order">
        ...
        <div class="box-body">
          ...
          <a
            class="my-btn"
            @click="reqParams.payType = 3"
            :class="{ active: reqParams.payType === 3 }"
            href="javascript:;"
            >双休日、假日送货：周六至周日</a
          >
        </div>
        ...
        <div class="box-body">
          <a
            class="my-btn"
            @click="reqParams.payChannel = 1"
            :class="{ active: reqParams.payChannel === 1 }"
            href="javascript:;"
            >在线支付</a
          >
          <a
            class="my-btn"
            @click="reqParams.payChannel = 2"
            :class="{ active: reqParams.payChannel === 2 }"
            href="javascript:;"
            >货到付款</a
          >
